...
3.2 Data Understanding and Preparation	3
3.3 Modeling and Evaluation	3
4 Results	4
5 Discussion	4
...
→ See screenshot and example in Section 5.2
6.	Evaluation
...
1.	A semantic similarity-based classification system that labels political tweets as true, false, or unsure using a multilingual transformer model.
...
Resources such as AlgorithmWatch and AI Now Institute emphasize these risks in their critical analyses of automated decision-making systems across Europe.
